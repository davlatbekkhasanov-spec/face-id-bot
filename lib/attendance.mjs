...
import { shiftMsFor, shiftStartFor, shiftEndFor, shiftHoursFor, formatShiftLabel } from "./shifts.mjs";
import {
  getDb,
  getStaffState,
  saveStaffState,
...
export function buildAttendanceCard(ev, employees) {
  ...
  return getDb().transaction(() => {
    ...
    const card = {
      ...
      shiftEnd: shiftEndFor(staff, key),
      shiftHours: shiftHoursFor(staff),
      shiftLabel: formatShiftLabel(staff, key),
      ...month,
    };
